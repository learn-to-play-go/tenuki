...
Renderer.prototype = {
  ...
  renderLabels: function renderLabels(intersections) {
    var _this3 = this;

    intersections.forEach(function (intersection) {
      _this3.renderIntersection(intersection);
    });
  },
  ...
  renderTerritory: function renderTerritory(territory, deadStones) {
    ...
    deadStones.forEach(function (point) {
      _utils2.default.addClass(_this4.grid[point.y][point.x], "dead");
    });

    territory.black.forEach(function (territoryPoint) {
      _utils2.default.addClass(_this4.grid[territoryPoint.y][territoryPoint.x], "territory-black");
    });

    territory.white.forEach(function (territoryPoint) {
      _utils2.default.addClass(_this4.grid[territoryPoint.y][territoryPoint.x], "territory-white");
    });
  }
};
